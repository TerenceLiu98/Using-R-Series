...
\thesistitle{Beijing PM2.5 Data Analysis} % Your thesis title, this is used in the title and abstract, print it elsewhere with \ttitle

\supervisor{Dr.Ye \textsc{Hua Jun} \\Dr.He \textsc{Ping}} % Your supervisor's name, this is used in the title page, print it elsewhere with \supname
...
\author{Junjie \textsc{LIU} \\ Daichen \textsc{YAO} \\ Yun \textsc{YANG}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\keywords{Statistics, regression} % Keywords for your thesis, this is not currently used anywhere in the template, print it elsewhere with \keywordnames
...
\faculty{\href{http://faculty.university.com}{Statistics}} % Your faculty's name and URL, this is used in the title page and abstract, print it elsewhere with \facname
...
\noindent Signed: Junjie \textsc{LIU} \ Daichen \textsc{YAO} \ Yun \textsc{YANG}\\
...
%I would like to dedicate this dissertation to our teachers \dots
%\end{abstract}
